          ...
          <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="py-6 px-6 lg:px-8">
              ...
              <form class="space-y-6">
                ...
                <ComboBoxUsers :options="users" :placeholder="`User`" :header="`Requestor Name`" @selected="cbName" />
...
<script>
import { getUserById } from '~~/backend/models/userModel';
export default {
  name: "large-modal",
  data() {
    return {
  ...
  methods: {
    ...
    // async getUserById() {
    //   try {
    //     const res = await axios.get(`http://localhost:8000/users/${this.id}`);
    //     this.
    //   }
    // }
  }
